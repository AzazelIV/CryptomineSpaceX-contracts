...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0x6A31f1F6D82F640155893F851C6d25D448c2d7Dd;
...
contract CashCowToken is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x7a1152eDc1A7b231a70ce7C4A5d7197aE337b615;   //Dev&Marketing Wallet
    ...
    string private _name = "Refined Viltrumita";
    string private _symbol = "VLTR";
    uint8 private _decimals = 18;
    
    uint256 public _taxFee = 5;
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _charityFee = 5; // we dont donate to charity, we will use this for marketing and development!!!!
